...
nohup python -u ga_attack_multiprocess.py --mode=ATTACK --n_processes=12 --n_fake_users=2 --selection_mode='ROULETTE' --pop_size=300 --train_frac=0.01 &
nohup python -u ga_attack_multiprocess.py --mode=ATTACK --n_processes=12 --n_fake_users=8 --selection_mode='ROULETTE' --pop_size=300 --train_frac=0.01 &
nohup python -u ga_attack_multiprocess.py --mode=ATTACK --n_processes=12 --n_fake_users=16 --selection_mode='ROULETTE' --pop_size=300 --train_frac=0.01 &
nohup python -u ga_attack_multiprocess.py --mode=ATTACK --n_processes=12 --n_fake_users=32 --selection_mode='ROULETTE' --pop_size=300 --train_frac=0.01 &

#nohup nice -10 python -u random_attack.py --n_fake_users=2  --pos_ratio=0.02   --pop_size=2000 --train_frac=0.01  &
##nohup nice -10 python -u random_attack.py --n_fake_users=4   --pos_ratio=0.02 --pop_size=2000 --train_frac=0.01  &
#nohup nice -10 python -u random_attack.py --n_fake_users=8    --pos_ratio=0.02 --pop_size=2000 --train_frac=0.01  &
##nohup nice -10 python -u random_attack.py --n_fake_users=12  --pos_ratio=0.02 --pop_size=2000 --train_frac=0.01  &
#nohup nice -10 python -u random_attack.py --n_fake_users=16   --pos_ratio=0.02 --pop_size=2000 --train_frac=0.01  &
#nohup nice -10 python -u random_attack.py --n_fake_users=32   --pos_ratio=0.02 --pop_size=2000 --train_frac=0.01  &
##nohup nice -10 python -u random_attack.py --n_fake_users=64  --pos_ratio=0.02 --pop_size=2000 --train_frac=0.01  &
##nohup nice -10 python -u random_attack.py --n_fake_users=128 --pos_ratio=0.02 --pop_size=2000 --train_frac=0.01  &
