...
nohup nice -15 python ga_attack_multiprocess.py --n_processes=4  --n_fake_users=2 --selection='RANDOM' --pop_size=1000  --n_generations=100 --train_frac=0.01 --save=False &
nohup nice -15 python ga_attack_multiprocess.py --n_processes=4  --n_fake_users=4 --selection='RANDOM' --pop_size=1000  --n_generations=100 --train_frac=0.01 --save=False &
nohup nice -15 python ga_attack_multiprocess.py --n_processes=4  --n_fake_users=8 --selection='RANDOM' --pop_size=1000  --n_generations=100 --train_frac=0.01 --save=False &
nohup nice -15 python ga_attack_multiprocess.py --n_processes=4  --n_fake_users=16 --selection='RANDOM' --pop_size=1000  --n_generations=100 --train_frac=0.01 --save=False &
nohup nice -15 python ga_attack_multiprocess.py --n_processes=4  --n_fake_users=32 --selection='RANDOM' --pop_size=1000  --n_generations=100 --train_frac=0.01 --save=False &
nohup nice -15 python ga_attack_multiprocess.py --n_processes=4  --n_fake_users=64 --selection='RANDOM' --pop_size=1000  --n_generations=100 --train_frac=0.01 --save=False &
nohup nice -15 python ga_attack_multiprocess.py --n_processes=4  --n_fake_users=128 --selection='RANDOM' --pop_size=1000  --n_generations=100 --train_frac=0.01 --save=False &
nohup nice -15 python ga_attack_multiprocess.py --n_processes=4  --n_fake_users=256 --selection='RANDOM' --pop_size=1000  --n_generations=100 --train_frac=0.01 --save=False &
nohup nice -15 python ga_attack_multiprocess.py --n_processes=4  --n_fake_users=512 --selection='RANDOM' --pop_size=1000  --n_generations=100 --train_frac=0.01 --save=False &
nohup nice -15 python ga_attack_multiprocess.py --n_processes=4  --n_fake_users=1024 --selection='RANDOM' --pop_size=1000  --n_generations=100 --train_frac=0.01 --save=False &
